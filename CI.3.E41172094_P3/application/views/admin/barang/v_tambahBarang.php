      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="card">
            ...
            <div class="card-body">
              <form action="<?= site_url('barang/validasiTambah'); ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label class="bmd-label-floating" for="nama_barang">Nama barang </label>
                      <input type="text" name="nama_barang" class="form-control <?php echo form_error('name') ? 'is-invalid':'' ?>" id="nama_barang">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="harga" class="form-control <?php echo form_error('name') ? 'is-invalid':'' ?>" >
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <a href="<?= site_url('barang'); ?>" class="btn btn-danger pull-right" >Batal
