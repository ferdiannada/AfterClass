<body class="">
  <div class="wrapper ">
    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="index.php?page=profile">Edit Barang</a>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="card">
            <div class="card-header card-header-success">
              ...
              <p class="card-category">Merubah data </p>
            </div>
            <div class="card-body">
              <form action="" method="post">
                      <input type="hidden" name="id_barang" class="form-control" value="<?= $edit['id_barang']; ?>">

                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label class="bmd-label-floating" for="nama_barang">Nama barang </label>
                      <input type="text" name="nama" class="form-control" id="nama_barang" value="<?= $edit['nama_barang']; ?>">
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="harga" class="form-control" value="<?= $edit['harga_barang']; ?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="deskripsi" id="deskripsi" rows="5"><?= $edit['deskripsi_barang']; ?></textarea>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-md-4">
          <div class="card card-profile">
            ...
            <div class="card-body">
              <h6 class="card-category text-gray"><?= $edit['nama_barang']; ?></h6>
                <h4 class="card-title">Rp<?= number_format($edit['harga_barang']); ?></h4>
                <p class="card-description">
                <?= $edit['deskripsi_barang']; ?>
                </p>
