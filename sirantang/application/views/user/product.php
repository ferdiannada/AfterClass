  							...
  							<div class="content">
  								...
  								<div class="hover-icons">
  									<ul>
  										...
  										<li><a href="#" data-toggle="modal" data-target="#quick-view-modal-container<?=$b->id;?>" data-tooltip="Quick View"><i class="icon ion-md-open"></i></a></li>
  									</ul>
  								</div>
  							</div>
  						</div>
