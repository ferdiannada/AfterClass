        ...
        <div class="section-wrapper">
          ...
          <div class="form-layout">
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Nama Dosen: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="namadosen" placeholder="Nama" required>
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Email address: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="email" name="emaildosen" placeholder="Email" required>
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-8">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">Alamat: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="alamatdosen" placeholder="Alamat" required>
                </div>
              </div><!-- col-8 -->
              <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">No HP: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="tel" name="nodosen" placeholder="No Hp" required>
                </div>
              </div><!-- col-4 -->
            </div><!-- row -->
