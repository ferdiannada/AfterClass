          ...
          <form action="" method="post">
            <div class="form-layout">
              <div class="row mg-b-25">
                ...
                <input class="form-control" type="text" id="kdbarang" name="kdbarang" value="<?= $barang['kdbarang']; ?>" hidden>  
                <div class="col-lg">
                  <div class="form-group">
                    <label class="form-control-label">Nama Barang: <span class="tx-danger">*</span></label>
                    <input class="form-control" type="text" id="namabarang" name="namabarang" value="<?= $barang['namabarang']; ?>">
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="stokbarang" name="stokbarang" value="<?= $barang['stokbarang']; ?>">
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="hargabarang" name="hargabarang" value="<?= $barang['hargabarang']; ?>">
                ...
                <div class="col-lg-8">
                  <div class="form-group mg-b-10-force">
                    ...
                    <textarea rows="3" class="form-control" id="deskripsi" name="deskripsi" ><?= $barang['deskripsi']; ?></textarea>
              ...
              <div class="form-layout-footer">
                <button type="submit" class="btn btn-primary bd-0">Edit Barang</button>
