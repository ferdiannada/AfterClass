      ...
      <div class="container">
        <ul class="nav">
          ...
          <li class="nav-item with-sub active">
            ...
            <div class="sub-item">
              <ul>
                <li><a href="admin/data_barang">Data Barang</a></li>
    ...
    <div class="slim-mainpanel">
      <div class="container">
        <div class="slim-pageheader">
          ...
          <h6 class="slim-pagetitle">Data Dosen</h6>
        </div><!-- slim-pageheader -->
            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-25p">NIP</th>
                  <th class="wd-25p">Nama Dosen</th>
                  <th class="wd-15p">Alamat Dosen</th>
