    								...
    								<tbody>
    									...
    									foreach ($cart as $item):
    										...
    										<tr>
    											...
    											<td class="pro-quantity"><div class="pro-qty"><input type="text" class="form-control input-sm" name="cart[<?php echo $item['id'];?>][qty]" value="<?php echo $item['qty'];?>" /></div></td> 
    						...
    						<div class="col-lg-6 col-12 d-flex">
    							...
    							<div class="cart-summary">
    								<div class="cart-summary-wrap">
    									...
    									<h2>Grand Total <span><?php echo number_format($grand_total); ?></span></h2>
    								</div>
