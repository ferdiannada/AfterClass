    ...
    public function index()
    {
      // Konfigurasi email
        $config = [
               ...
               'smtp_user' => 'sasqiadwiarr@gmail.com',    // Ganti dengan email gmail kamu
               'smtp_pass' => 'xxxxxxxxxxx',      // Password gmail kamu
               'smtp_port' => 587,
               'crlf'      => "\r\n",
               'newline'   => "\r\n"
           ];
        ...
        $this->email->from('sasqiadwiarr@gmail.com', 'Sasqia');

        // Email penerima
        $this->email->to('verenrachel5758@gmail.com'); // Ganti dengan email tujuan kamu

        // Lampiran email, isi dengan url/path file
        $this->email->attach('https://masrud.com/content/images/20181215150137-codeigniter-smtp-gmail.png');

        // Subject email
        $this->email->subject('Kirim Email dengan SMTP Gmail | sasqia');
