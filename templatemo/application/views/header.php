...
-->
    <!-- load stylesheets -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/font.css');?>">  <!-- Google web font "Open Sans" -->
    <link rel="stylesheet" href="<?php echo base_url ('assets/css/bootstrap.min.css');?>">                                      <!-- Bootstrap style -->
    <link rel="stylesheet" href="<?php echo base_url ('assets/css/magnific-popup.css');?>">                                <!-- Magnific pop up style, http://dimsemenov.com/plugins/magnific-popup/ -->
                ...
                <div class="tm-left-right-container">
                    ...
                    <div class="tm-blue-bg tm-left-column">                        
                        <div class="tm-logo-div text-xs-center">
                            <img src=<?php echo base_url("assets/img/tm-neaty-logo.png");?> alt="Logo">
